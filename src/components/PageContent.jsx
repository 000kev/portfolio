export default function PageContent()  {
    return (
        <div className="flex flex-col md:flex-row">
            ...
            <span className="w-screen md:my-16 basis-1/2 font-serif">
                ...
                <p className="text-center text-lg m-5 w-5/6 my-3 p-1 md:mx-auto">
                    ...
                    after his parents migrated from the Democratic Republic of Congo, he has continously strived and succeeded in breaking his own personal 
                ...
                <p className="text-center text-lg m-5 w-5/6 my-3 p-1 md:mx-auto">
                    ...
                    academics, in sports, and in his own personal growth through an exchange program to Germany, a language he has now become 
                ...
                <p className="text-center text-lg m-5 w-5/6 my-3 p-1 md:mx-auto">
                    As an example, this entire website: every click, every hover, every single pixel of this user-friendly User Inteface
                    was created by Kevin himself. From the code to the web deployment, Kevin is responsible for it all, and this represents
                    only a fraction of what makes Kevin the Global Citizen that he is.
                </p>
            </span>
        </div>
    );
